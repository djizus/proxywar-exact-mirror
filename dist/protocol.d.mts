...
export declare const MAX_PROJECT_ROUTES = 64;
...
export type MirrorRequest = IngestMirrorRequest | FinalizeMirrorRequest | ProjectMirrorRequest;
...
export type TransportLifecycleEvent = {
    eventID: string;
    type: "launch_observed" | "launch_failed" | "plan_updated" | "retreat_started" | "arrived" | "attack_converted" | "friendly_returned" | "retreat_returned" | "destroyed" | "path_failed";
    tick: number;
    unitID: number | null;
...
export type ExecutionStateCapabilityName = "attacks" | "constructions" | "transports" | "tradeShips" | "ports" | "trainStations" | "trains" | "retreats" | "nukes" | "samInterceptions" | "warships" | "diplomacy" | "playerTiming" | "staggerCounters";
...
export type PlayerTimingExecutionState = {
    ...
    lastDonationTicks: Array<{
        recipientPlayerID: string;
        tick: number;
    }>;
    lastEmojiTicks: Array<{
        recipientSmallID: number | string;
        tick: number;
    }>;
...
export type ExecutionStateSidecar = {
    schemaVersion: 1;
    tick: number;
    capabilities: Record<ExecutionStateCapabilityName, ExecutionStateCapability>;
...
export type MirrorProjectRefusalCode = "mirror_not_ready" | "mirror_advancing" | "mirror_not_exact" | "stale_tick" | "state_hash_mismatch";
...
export type MirrorProjectResult = MirrorProjectSuccessResult | MirrorProjectRefusalResult;
export declare function parseMirrorRequest(message: unknown): MirrorRequest;
export declare function parseMirrorProjectQuery(value: unknown): MirrorProjectQuery;
export declare function mirrorRequestIDForError(message: unknown): MirrorRequestID | null;
